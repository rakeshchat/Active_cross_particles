...
//for 30X30 system we can go upto rho=0.13
...
double   rho,c,d,slot1,slot2,slot3,slot4,rT=1.0,rA,rR,r,dt,pT,pA,pR,pTA,u,v,y1,y2;
...
//============================================
sprintf(outputfile, "dataR");
//sprintf(outputfile, "dataRR-QR_RA%.2f-rho%.2f",rA,rho);
//sprintf(outputfile, "QRmsd-%.2f-%.3f-%.2f",rA,rR,rho);
//sprintf(outputfile, "msdlockrA10-%.2f-%.2fdata%.f",rR,rho,seconds);
fp = fopen(outputfile,"w");
//=============================================



for(rho=0.005; rho<0.135; rho+=0.005){
//for(rR=0.001; rR<80.0; rR*=1.3){
...
printf("%lf  %lf\n",rho,1.0*rotation/realz/tmax/2.0/rR);
